...
This directory contains mathematical work beyond the fixed \(p=3/2\) paper and its Lean formalization. Material here is not part of the machine-checked theorem package unless explicitly stated.
...
These topics are research directions rather than claims of the fixed formalized paper.
...
- At \(p=4/3\), the earlier manuscript develops a bilateral-Gaussian compactness mechanism.
